...
class BulkImportApi extends SugarApi
{
    ...
    public function bulkImport($api, $args)
    {
        ...
        global $current_user;
        global $sugar_config;
        $old_value = null; //flag for checking calculated fields bit
        ...
        //disable caclulated fields calculation, as it causes a huge performance issue
        if (isset($sugar_config['disable_related_calc_fields']))
        {
            $old_value = $sugar_config['disable_related_calc_fields'];
        }
        ...
        if (!empty($old_value)) {
            $sugar_config['disable_related_calc_fields'] = $old_value;
        } else {
            unset($sugar_config['disable_related_calc_fields']);
        }
